...
public class EarthquakeCityMap extends PApplet {
	...
	private void selectMarkerIfHover(List<Marker> markers)
	{
		...
		for (Marker e : markers) {
			module5.CommonMarker ele = (module5.CommonMarker)e;
			if (ele.isInside(map, mouseX, mouseY)) {
				lastSelected = ele;
	...
	public void checkEarthquakesForClick() {
		...
		for (Marker e : quakeMarkers) {
			module5.EarthquakeMarker marker = (module5.EarthquakeMarker)e;
	...
	public void checkCitiedForClick() {
